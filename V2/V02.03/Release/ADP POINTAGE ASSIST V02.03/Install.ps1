...
$Application_Version = "V02.03"       # Application version
$Editor = "CLS"                    # Editor
...
EXECUTE_INSTALLATION_MSI "ADP POINTAGE ASSIST V02.03.msi" "" "/qn /l* `"C:\temp\sccm_logs\Install_ADP POINTAGE ASSIST V02.03.log`"" "{83ADA56E-BC40-41DF-9A92-CE0A9D26A14B}" "" "" 0 64

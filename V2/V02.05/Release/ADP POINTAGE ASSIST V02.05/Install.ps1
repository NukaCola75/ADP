...
$Application_Version = "V02.05"       # Application version
$Editor = "CLS"                    # Editor
...
EXECUTE_MIGRATION_MSI "{612DB342-226B-40AF-A644-1179F82E4B11}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.04.log`"" "{612DB342-226B-40AF-A644-1179F82E4B11}" "" "" 0 64
EXECUTE_MIGRATION_MSI "{83ADA56E-BC40-41DF-9A92-CE0A9D26A14B}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.03.log`"" "{83ADA56E-BC40-41DF-9A92-CE0A9D26A14B}" "" "" 0 64
EXECUTE_MIGRATION_MSI "{00980A83-5E25-44BC-9BD8-CB173017F607}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.02.01.log`"" "{00980A83-5E25-44BC-9BD8-CB173017F607}" "" "" 0 64
EXECUTE_MIGRATION_MSI "{C51B482A-2E13-4F2F-BEB9-D20D475CD8B3}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.02.01.log`"" "{C51B482A-2E13-4F2F-BEB9-D20D475CD8B3}" "" "" 0 64
EXECUTE_MIGRATION_MSI "{FE41F054-D03A-4244-887E-00ED680C82C5}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.01.log`"" "{FE41F054-D03A-4244-887E-00ED680C82C5}" "" "" 0 64
...
If ($Global:Err_Return -eq 0)
{
	...
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.04" $Arch
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.03" $Arch
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.02" $Arch
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.01" $Arch
...
EXECUTE_INSTALLATION_MSI "ADP POINTAGE ASSIST V02.05.msi" "" "/qn /l* `"C:\temp\sccm_logs\Install_ADP POINTAGE ASSIST V02.05.log`"" "{B862C18F-0108-4AB3-A6EA-6B8DA62FF1A6}" "" "" 0 64

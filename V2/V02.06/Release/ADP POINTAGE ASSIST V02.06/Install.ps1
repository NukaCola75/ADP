...
$Application_Version = "V02.06.03"       # Application version
$Editor = "CLS"                    # Editor
...
EXECUTE_MIGRATION_MSI "{1FE5F58F-85A9-4065-9FF9-84912F83892A}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.06.02.log`"" "{1FE5F58F-85A9-4065-9FF9-84912F83892A}" "" "" 0 64
EXECUTE_MIGRATION_MSI "{050DDBDE-1DF2-41AA-AF34-4D75E37B56E5}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.06.01.log`"" "{050DDBDE-1DF2-41AA-AF34-4D75E37B56E5}" "" "" 0 64
EXECUTE_MIGRATION_MSI "{AF1DCB2F-B98E-4EC1-95BD-34C8C7E4D21C}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.06.log`"" "{AF1DCB2F-B98E-4EC1-95BD-34C8C7E4D21C}" "" "" 0 64
...
If ($Global:Err_Return -eq 0)
{
	...
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.06.02" $Arch
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.06.01" $Arch
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.06" $Arch
	CLS_REMOVEREGSIGN "ADP POINTAGE ASSIST" "V02.05" $Arch
...
EXECUTE_INSTALLATION_MSI "ADP POINTAGE ASSIST V02.06.msi" "" "/qn /l* `"C:\temp\sccm_logs\Install_ADP POINTAGE ASSIST V02.06.03.log`"" "{C1B0757E-4B1B-4FC4-9D98-147C9186D18F}" "" "" 0 64

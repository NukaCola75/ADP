...
EXECUTE_UNINSTALL_MSI "{C1B0757E-4B1B-4FC4-9D98-147C9186D18F}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.06.03.log`"" "{C1B0757E-4B1B-4FC4-9D98-147C9186D18F}" "" "" 0 64
...
If ($Global:Err_Return -eq 0)
{
	...
	Remove-Item -Path "HKCU:\Software\CLS\APP\ADP" -Recurse -Force -ErrorAction 'SilentlyContinue'

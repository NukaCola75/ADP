...
$Application_Version = "V02.04"       # Application version
$Editor = "CLS"                    # Editor
...
EXECUTE_INSTALLATION_MSI "ADP POINTAGE ASSIST V02.04.msi" "" "/qn /l* `"C:\temp\sccm_logs\Install_ADP POINTAGE ASSIST V02.04.log`"" "{612DB342-226B-40AF-A644-1179F82E4B11}" "" "" 0 64

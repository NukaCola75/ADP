...
$Application_Version = "V02.02"       # Application version
$Editor = "CLS"                    # Editor
...
EXECUTE_INSTALLATION_MSI "ADP POINTAGE ASSIST V02.02.msi" "" "/qn /l* `"C:\temp\sccm_logs\Install_ADP POINTAGE ASSIST V02.02.log`"" "{00980A83-5E25-44BC-9BD8-CB173017F607}" "" "" 0 64

...
EXECUTE_UNINSTALL_MSI "{00980A83-5E25-44BC-9BD8-CB173017F607}" "/qn /l* `"C:\temp\sccm_logs\Remove_ADP POINTAGE ASSIST V02.02.log`"" "{00980A83-5E25-44BC-9BD8-CB173017F607}" "" "" 0 64

...
$Application_Name = "ADP POINTAGE ASSIST"          # Nom de l'application
$Application_Version = "V02.00"       # Version de l'application Vxx.xx.xx
$Editor = "CLS"                    # Editeur
$Install_Path = "C:\Users\$user\AppData\Roaming\CLS\ADP POINTAGE ASSIST"              # Install folder of the application
$Technologie = "MSI"               # MSI, EXE, APPX, CAB or MSU
$Arch = 64                         # 32 or 64
